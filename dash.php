        ...
        <div class='d-flex flex-column' id='content-wrapper'>
                                ...
                                <div class='card-body'>
                                    <div class='row align-items-center no-gutters'>
                                        <div class='col mr-2'>
                                            ...
                                            <div class='text-dark font-weight-bold h5 mb-0'><span><?php echo($users->countausers());?></span></div>
                                        </div>
                                ...
                                <div class='card-body' style='height: 84px;'>
                                    <div class='row align-items-center no-gutters'>
                                        <div class='col mr-2'>
                                            ...
                                            <div class='text-dark font-weight-bold h5 mb-0'><span><?php echo($users->countiusers());?></span></div>
                                        </div>
                                ...
                                <div class='card-body'>
                                    <div class='row align-items-center no-gutters'>
                                        <div class='col mr-2'>
                                            ...
                                            <div class='text-dark font-weight-bold h5 mb-0'><span><?php echo($users->countpusers());?></span></div>
                                        </div>
                        ...
                        <div class='col-lg-7 col-xl-8'>
                            <div class='card shadow mb-4'>
                                <div class='card-header d-flex justify-content-between align-items-center' style='width: 730;'>
                                    ...
                                    <div class='dropdown no-arrow'><i class='fas fa-ellipsis-v text-gray-400'></i></button>
            ...
            <footer class='bg-white sticky-footer'>
                <div class='container my-auto'>
                    <div class='text-center my-auto copyright'><span>Copyright © ASTU 2022</span></div>
                </div>
            </footer>
