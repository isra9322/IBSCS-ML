...
if (isset($updateUser)) {
 ...
 <div class="card ">
   <div class="card-header">
          <h3 >User Profile <span class="float-right"> <a href="index.php" class="btn btn-primary" style="margin-right: 5px;">Back</a> </h3>
        </div>
        <div class="card-body">
            ...
            <?php } elseif(Session::get("roleid") == '2') {?>
              ...
              <?php   }else{ ?>
                  <div class="form-group">
                    ...
                    <a class="btn btn-primary" href="dash.php">Ok</a>
                  </div>
                <?php } ?>
