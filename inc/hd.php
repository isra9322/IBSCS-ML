        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <nav class="navbar navbar-expand-md navbar-dark bg-dark card-header">
                    <a class="navbar-brand" href="index.php"><i class="fas fa-home mr-2"></i>IBSCS ML Admin port</a>           
            ...
            <?php if (Session::get('roleid') == '1') { ?>
              <li class="nav-item">
                  ...
                  <a class="nav-link" href="allusers.php"><i class="fas fa-users mr-2"></i>system User lists </span></a>
              </li>
              <li class="nav-item
